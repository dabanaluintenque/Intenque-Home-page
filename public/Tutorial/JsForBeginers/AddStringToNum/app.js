...
function usingSliceFunction(){
 ...
 "The method takes 2 parameters: the start position, and the end position (end -1)"+"<br>"+
    "Here is the example of slicing letters ABCDEFGHIJKLMNOPQRSTUVWXYZ: slice(0,7)" +"<br><br>"+"output is: "+  letter.slice(0,7);
...
function usingSubstringFunction(){
   ...
   "The difference is that substring() cannot accept negative indixes."+"<br>"+
    ...
    "substring(0,7) in 26 letter." +"<br><br>"+ "output is: " +letter.substring(0,7);
}
function usingCharAt(){

    let phrase = document.getElementById('example6').innerHTML;

     document.getElementById('example6').innerHTML="D is in the possition 6 because we included the white space: " +phrase.charAt(6);
}
